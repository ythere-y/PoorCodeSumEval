    ...
    def save_json_files(
        ...
        if self.args.save_generations:
            with open(save_generations_path, "w") as fp:
                ...
                print(
                    f"{Fore.LIGHTYELLOW_EX}generations were saved at {save_generations_path}{Fore.RESET}"
                )
        if self.args.save_references:
            with open(save_references_path, "w") as fp:
                json.dump(references, fp)
                print(
                    f"{Fore.LIGHTYELLOW_EX}references were saved at {save_references_path}{Fore.RESET}"
                )
