        ...
        for idx, task in enumerate(task_names):
            ...
            if args.generation_only:
                ...
                if accelerator.is_main_process:
                    ...
                    print(
                        f"{colorama.Fore.GREEN}args.save_generations_path = {args.save_generations_path}, args.save_references_path = {args.save_references_path} {save_generations_path}{colorama.Style.RESET_ALL}"
                    )
